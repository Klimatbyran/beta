...
const teamMembers: TeamMember[] = [
  {
    ...
    imageUrl: "https://images.unsplash.com/photo-1519345182560-3f2917c472ef?w=300&h=300&fit=crop",
  },
  {
  ...
  },
  {
    ...
    description: "Fullstackutvecklare med passion för open source och att skapa digitala lösningar som ger värde till människor och samhälle. Har tidigare arbetat med startups och ideella organisationer i tidiga skeden, bland annat på We Don't Have Time.",
    imageUrl: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=300&h=300&fit=crop",
  },
  {
    name: "Alexandra Palmquist",
    role: "Miljövetare",
    description: "Miljövetare med fokus på klimat och företagsdata. Tidigare erfarenhet från FN i Latinamerika, numera hemmastadd i Stockholms tech startup-scen för att driva klimatomställningen.",
...
const boardMembers: TeamMember[] = [
  {
    ...
    description: "Digital entreprenör och en av Sveriges mest inflytelserika personer inom tech. VD och grundare av Iteam och Öppna skolplattformen.",
    imageUrl: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=300&h=300&fit=crop",
  },
  {
    name: "Anna Loverus",
    role: "Styrelseledamot",
    description: "Digital strateg och tidigare chef för sociala medier på Spotify och H&M. VD och grundare av Better Odds.",
  ...
  },
  {
    ...
    role: "Styrelseledamot",
    description: 'Hållbarhetsstrateg på Doings, tidigare planner på Forsman & Bodenfors, författare till boken "Hållbariseringen", Årets marknadsföringsbok 2022.',
    ...
    <div className="max-w-[1200px] mx-auto space-y-24">
      ...
      <Accordion type="single" collapsible className="space-y-6">
        <AccordionItem value="what" className="border-none">
          ...
          <AccordionContent className="p-8">
            <div className="prose prose-invert max-w-3xl space-y-4">
              <p>Klimatkollen är en medborgarplattform som hjälper medborgare, företag och organisationer att få koll på klimatomställningen, genom att samla in och visualisera klimatdata.</p>
              <p>Vi visar hur det går med utsläppen, jämfört med hur det borde gå, så att det blir begripligt för allmänheten, bidrar till en faktabaserad debatt och stärker opinionen för klimatåtgärder.</p>
              <p>Vår vision är att beslutsfattare i politik och näringsliv ska påverkas av en välinformerad och växande opinion till att genomföra åtgärder som sänker utsläppen i linje med Parisavtalet.</p>
            </div>
          </AccordionContent>
        </AccordionItem>
        ...
        <AccordionItem value="financing" className="border-none">
          ...
          <AccordionContent className="p-8">
            <div className="prose prose-invert max-w-3xl space-y-4">
              <p>Under 2024 och 2025 får Klimatkollen finansiell uppbackning av Google.org som en av två svenska mottagare av Google.org Impact Challenge: Tech for Social Good.</p>
              <p>Under 2023 drevs Klimatkollen med stöd från Postkodstiftelsen. Uppstarten 2022 finansierades av Världsnaturfonden WWF, ClimateView, We Don't Have Time och Argand Partners.</p>
              <p>Mycket av arbetet är ideellt, därför välkomnar vi fler samarbetspartners och ekonomiskt stöd för att kunna skala upp!</p>
              <div className="bg-blue-5/30 rounded-level-2 p-6 mt-8">
                <Text variant="large">Skänk gärna en slant!</Text>
                <Text className="text-grey">Varje krona ger oss muskler att visa upp mer data.</Text>
                <Text variant="large" className="text-blue-2 mt-2">Bankgiro: 5793-3178</Text>
              </div>
            </div>
          </AccordionContent>
        </AccordionItem>
          ...
          <AccordionContent className="p-8">
            <div className="prose prose-invert max-w-3xl space-y-8">
              <div className="space-y-4">
                ...
                <p>Under 2023 fick Klimatkollen stöd av Postkodstiftelsen för att ta tempen på hur det går med klimatomställningen i kommunerna. I dag kan du se hur det går med koldioxidutsläppen. Nu visar vi även vad kommunerna gör för att minska dem.</p>
              </div>

              <div className="space-y-4">
                <Text variant="h4">Riksdagsvalet 2022</Text>
                <p>Inför riksdagsvalet 2022 ansvarade Klimatkollen för två unika projekt:</p>
                  ...
                  >
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <Text className="text-grey">Analys av riksdagspartiernas klimatmål</Text>
                      </div>
                  ...
                  >
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <Text className="text-grey">Beräkning av partiernas klimatåtgärder</Text>
                      </div>
                      <ArrowUpRight className="w-6 h-6" />
                    </div>
                  </a>
