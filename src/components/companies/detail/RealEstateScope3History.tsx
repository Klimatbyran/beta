    ...
    <div className={cn('bg-black-2 rounded-level-1 p-16', className)}>
      ...
      <div className="mt-8 p-6 bg-black-1 rounded-level-2">
        <Text variant="h4" className="mb-2">
          Viktiga trender för fastighetssektorn
        </Text>
        <Text variant="muted">
          Scope 3-utsläpp i fastighetssektorn domineras ofta av kategorierna
          "Inköpta varor & tjänster" (1), "Kapitalvaror" (2) och
          "Energirelaterade aktiviteter" (3). Dessa kategorier inkluderar
