      ...
      <div className="bg-black-1 rounded-level-2 p-6">
        <div className="space-y-2">
          <div className="text-sm text-grey">
            {municipality.name} har en{' '}
            {municipality.historicalEmissionChangePercent < 0
              ? 'positiv'
              : 'negativ'}{' '}
            trend, koldioxidbudgeten tar slut:
          </div>
      ...
      <div className="space-y-4">
        <div className="flex items-center gap-2">
          <h3 className="text-sm text-grey">
            Utsläppen i siffror{' '}
            {municipality.totalApproximatedHistoricalEmission >= 1500000
              ? '(miljoner ton CO₂)'
              : '(tusen ton CO₂)'}
          </h3>
          <TooltipProvider>
        ...
        <div className="grid grid-cols-3 gap-4">
          <div className="bg-[#FDE7CE]/10 rounded-level-2 p-4 space-y-1">
            ...
            <div className="text-2xl font-light text-[#FDE7CE]">
              {formatEmissions(
                municipality.totalApproximatedHistoricalEmission,
              )}
            </div>
          </div>
